              ...
              <div>
                ...
                {reportForm.image && (
                  <div className="mt-4 bg-gray-100 rounded-lg p-2">
                    <img src={reportForm.image} alt="Preview" className="w-full max-h-96 object-contain rounded-lg" />
                  </div>
                )}
              </div>
                  ...
                  <div key={report.id} className="bg-white rounded-xl shadow-md p-5">
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <button
                        ...
                        className="text-blue-900 hover:bg-blue-50 px-3 py-2 rounded-lg text-sm font-bold"
                      >
                        상세 보기
                      </button>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-2">건물명</label>
                  <select
                    value={filters.building}
                    onChange={(e) => setFilters({ ...filters, building: e.target.value })}
                    className="w-full px-3 py-2 border rounded-lg"
              ...
              <button
                onClick={() => setFilters({ dateRange: 'all', building: 'all' })}
                className="mt-4 w-full bg-blue-900 text-white py-2 rounded-lg font-bold hover:bg-blue-800"
              >
                조회
              </button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <div className="text-center">
                <p className="text-gray-600 font-medium mb-2">총 신고 건수</p>
                <p className="text-5xl font-bold text-blue-900">{getFilteredReports().length}건</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <StatisticsMap 
                reports={getFilteredReports()}
                onBuildingClick={(buildingStat) => {
                  setSelectedBuilding(buildingStat);
      ...
      {showBuildingModal && selectedBuilding && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b p-4 flex justify-between items-center">
              <div>
                <h3 className="text-xl font-bold">{selectedBuilding.building} 신고 현황</h3>
                <p className="text-sm text-gray-600 mt-1">총 {selectedBuilding.count}건의 신고</p>
              </div>
              <button 
                onClick={() => {
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                  <p className="text-sm text-blue-600 font-medium">접수 완료</p>
                  <p className="text-3xl font-bold text-blue-700 mt-2">{selectedBuilding.submitted}</p>
                </div>
                <div className="bg-yellow-50 rounded-xl p-4 border border-yellow-200">
                  <p className="text-sm text-yellow-600 font-medium">처리중</p>
                  <p className="text-3xl font-bold text-yellow-700 mt-2">{selectedBuilding.processing}</p>
                </div>
                <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                  <p className="text-sm text-green-600 font-medium">처리 완료</p>
                  <p className="text-3xl font-bold text-green-700 mt-2">{selectedBuilding.completed}</p>
                </div>
              </div>

              {/* 신고 목록 */}
              <h4 className="font-bold mb-4 text-lg">신고 내역</h4>
              <div className="space-y-3 max-h-[50vh] overflow-y-auto">
                {selectedBuilding.reports.map(report => (
                  <div key={report.id} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h5 className="font-bold">{report.floor} {report.room}</h5>
                          <UrgencyBadge urgency={report.urgency} />
                          <StatusBadge status={report.status} />
                        </div>
                        <p className="text-xs text-gray-500">
